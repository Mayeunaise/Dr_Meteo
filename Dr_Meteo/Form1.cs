namespace Dr_Meteo
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void lbl_Apres_demain_Click(object sender, EventArgs e)
        {

        }

        private void Lbl_lever_soleil_Click(object sender, EventArgs e)
        {

        }

        private void Lbl_VilleNom_Click(object sender, EventArgs e)
        {
